...
export const inputClassName =
  "w-full rounded-xl border border-gray-300 bg-surface-elevated py-3.5 text-[15px] text-ink outline-none transition placeholder:text-ink-muted/60 focus:border-brand focus:ring-4 focus:ring-brand-muted"
